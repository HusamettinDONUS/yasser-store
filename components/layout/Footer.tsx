          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="space-y-4">
              ...
              <div className="flex space-x-4">
                <Button size="icon" variant="ghost" className="text-slate-400 hover:text-primary">
        ...
        <div className="border-t border-slate-800 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex space-x-6 text-sm">
              <Link href={`/${locale}/privacy`} className="text-slate-400 hover:text-primary transition-colors">
                {t('footer.privacy')}
              </Link>
              <Link href={`/${locale}/terms`} className="text-slate-400 hover:text-primary transition-colors">
                {t('footer.terms')}
              </Link>
              <Link href={`/${locale}/shipping`} className="text-slate-400 hover:text-primary transition-colors">
                {t('footer.shipping')}
              </Link>
              <Link href={`/${locale}/returns`} className="text-slate-400 hover:text-primary transition-colors">
                {t('footer.returns')}
              </Link>
            </div>
          </div>
